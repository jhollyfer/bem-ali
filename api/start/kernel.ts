...
kernel.register(cors, {
  ...
  allowedHeaders: [
    ...
    'X-Timezone', // TIMEZONE (caso seja necessário trabalhar com horários diferentes)
  ],
...
kernel.register(swagger, {
  openapi: {
    info: {
      title: 'Matis API',
      version: '1.0.0',
      description: 'Matis API with JWT cookie-based authentication',
    },
    servers: [
      {
        url: Env.SERVER_URL,
...
kernel.register(scalar, {
  ...
  configuration: {
    title: 'Matis API',
    description: 'Matis API Documentation',
    version: '1.0.0',
    theme: 'default',
  },
});
